...
- (void)viewDidLoad {
    ...
    if ([self.detailTitle.text isEqualToString:@"Big Ben"]) {
        ...
        self.detailTextView.text = @"Big Ben is the nickname for the Great Bell of the clock at the north end of the Palace of Westminster in London, and often extended to refer to the clock and the clock tower.";
    ...
    if ([self.detailTitle.text isEqualToString:@"St Paul's Cathedral"]) {
        ...
        self.detailTextView.text = @"St Paul's Cathedral, London, is an Anglican cathedral, the seat of the Bishop of London and the mother church of the Diocese of London. It sits on Ludgate Hill at the highest point of the City of London.";
